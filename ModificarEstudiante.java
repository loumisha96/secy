...
public class ModificarEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(dpi_txt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        String carnet = carnet_txt.getText();
        estudiante encontrado = Administrar.listaEstudiante.buscar(carnet);
        if(encontrado != null){
            encontrado.correo = correo_txt.getText();
            encontrado.dpi = dpi_txt.getText();
            encontrado.nombre = nombre_txt.getText();
            encontrado.direccion = direccion_txt.getText();
        }
